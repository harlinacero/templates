...
import { vw_totalBilling, Vw_total_billing_by_month } from '../interfaces/vw_totalBilling.interface';
...
export class HomeService {
  ...
  getAllIndicators() {
    return this.http.get<RequestResult<vw_totalBilling[]>>(`${this.urls.urlbase}Home/GetAllIndicators`);
  }

  getAllBillingsByMonth() {
    return this.http.get<RequestResult<Vw_total_billing_by_month[]>>(`${this.urls.urlbase}Home/GetAllBillingsByMonth`);
  }
}
