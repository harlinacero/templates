...
/* harmony import */ var _detailbilling_detailbilling_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./detailbilling/detailbilling.component */ "./src/app/modules/billing/detailbilling/detailbilling.component.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _billing_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./billing.component */ "./src/app/modules/billing/billing.component.ts");
...
/* harmony import */ var src_app_shared_services_billing_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/shared/services/billing.service */ "./src/app/shared/services/billing.service.ts");
/* harmony import */ var src_app_shared_services_admin_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/shared/services/admin.service */ "./src/app/shared/services/admin.service.ts");
/* harmony import */ var src_app_shared_helpers_controlError_helper__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/shared/helpers/controlError.helper */ "./src/app/shared/helpers/controlError.helper.ts");
/* harmony import */ var _shared_services_aprovalMatrix_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./../../shared/services/aprovalMatrix.service */ "./src/app/shared/services/aprovalMatrix.service.ts");
/* harmony import */ var _pupup_billing_pupup_billing_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./pupup-billing/pupup-billing.component */ "./src/app/modules/billing/pupup-billing/pupup-billing.component.ts");
...
let BillingComponent = class BillingComponent {
    constructor(serviceBase, billingService, adminService, 
    // tslint:disable-next-line: align
    aprovalMatrixService, helper, 
    // tslint:disable-next-line: align
    dialog, route, router) {
        ...
        this.route = route;
        this.router = router;
        this.displayedColumns = ['numberbilling', 'providerid', 'billingtype', 'producttype', 'costcenterid', 'exchangerate',
    ...
    getAllBillings() {
        this.billingService.GetAllBilling()
            ...
            if (res.isSuccesfull) {
                ...
                this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](res.result);
    ...
    addCostCenter() {
        const dialogRef = this.dialog.open(_pupup_billing_pupup_billing_component__WEBPACK_IMPORTED_MODULE_9__["PupupBillingComponent"], {
            height: 'auto',
            width: 'auto',
            data: this.billing,
            disableClose: true
...
BillingComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./billing.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/billing/billing.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./billing.component.scss */ "./src/app/modules/billing/billing.component.scss")).default]
    })
], BillingComponent);
...
/* harmony import */ var _billing_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./billing-routing.module */ "./src/app/modules/billing/billing-routing.module.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm2015/common.js");
/* harmony import */ var _billing_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./billing.component */ "./src/app/modules/billing/billing.component.ts");
/* harmony import */ var _pupup_billing_pupup_billing_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./pupup-billing/pupup-billing.component */ "./src/app/modules/billing/pupup-billing/pupup-billing.component.ts");
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm2015/material.js");
/* harmony import */ var _detailbilling_detailbilling_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./detailbilling/detailbilling.component */ "./src/app/modules/billing/detailbilling/detailbilling.component.ts");
...
BillingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        declarations: [
            _billing_component__WEBPACK_IMPORTED_MODULE_5__["BillingComponent"],
            _pupup_billing_pupup_billing_component__WEBPACK_IMPORTED_MODULE_6__["PupupBillingComponent"],
            _detailbilling_detailbilling_component__WEBPACK_IMPORTED_MODULE_8__["DetailbillingComponent"]
        ],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"],
            _billing_routing_module__WEBPACK_IMPORTED_MODULE_2__["BillingRoutingModule"],
            _shared_shared_module__WEBPACK_IMPORTED_MODULE_1__["SharedModule"]
        ], entryComponents: [
            _pupup_billing_pupup_billing_component__WEBPACK_IMPORTED_MODULE_6__["PupupBillingComponent"]
        ],
        providers: [
            { provide: _angular_material__WEBPACK_IMPORTED_MODULE_7__["MAT_DIALOG_DATA"], useValue: { float: 'always' } }
        ]
    })
], BillingModule);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DetailbillingComponent", function() { return DetailbillingComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _shared_services_service_base__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./../../../shared/services/service.base */ "./src/app/shared/services/service.base.ts");
/* harmony import */ var _shared_enums_statesBilling_enum__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../../../shared/enums/statesBilling.enum */ "./src/app/shared/enums/statesBilling.enum.ts");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm2015/material.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
/* harmony import */ var src_app_shared_services_billing_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/shared/services/billing.service */ "./src/app/shared/services/billing.service.ts");
...
let DetailbillingComponent = class DetailbillingComponent {
    constructor(serviceBase, billingService, route, router) {
        this.serviceBase = serviceBase;
        this.billingService = billingService;
        this.route = route;
        this.router = router;
    ...
    getDetailBilling(numberBilling) {
        this.detailBillingSubscription = this.billingService.GetDetailBilling(numberBilling)
            .subscribe(res => {
            if (res.isSuccesfull) {
                this.detailBilling = res.result;
                this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_5__["MatTableDataSource"](res.result);
                this.dataSource.paginator = this.paginator;
                this.dataSource.sort = this.sort;
    ...
    validateIfCanAproval(detailBilling) {
    ...
    regectBilling() {
        const textAtrea = document.getElementById('rejectionCause').value;
        if (!!textAtrea) {
            this.billingService.ContinueAprovalProcess(this.numberBilling, _shared_enums_statesBilling_enum__WEBPACK_IMPORTED_MODULE_2__["StatusBillingEnum"].Rechazada, textAtrea).subscribe(res => {
                if (res.isSuccesfull) {
                    alert(res.result);
                    this.getDetailBilling(parseInt(this.numberBilling));
                }
    ...
    aprovalBilling() {
        const textAtrea = document.getElementById('message-text').value;
        if (!!textAtrea)
            this.observations = textAtrea;
        if (!!this.observations) {
            this.billingService.ContinueAprovalProcess(this.numberBilling, _shared_enums_statesBilling_enum__WEBPACK_IMPORTED_MODULE_2__["StatusBillingEnum"].Aprobada, this.observations).subscribe(res => {
                if (res.isSuccesfull) {
                    alert(res.result);
                    this.getDetailBilling(parseInt(this.numberBilling));
                }
...
DetailbillingComponent.ctorParameters = () => [
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_5__["MatPaginator"], { static: false })
], DetailbillingComponent.prototype, "paginator", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_5__["MatSort"], { static: false })
], DetailbillingComponent.prototype, "sort", void 0);
DetailbillingComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        selector: 'app-detailbilling',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./detailbilling.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/billing/detailbilling/detailbilling.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./detailbilling.component.scss */ "./src/app/modules/billing/detailbilling/detailbilling.component.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PupupBillingComponent", function() { return PupupBillingComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
/* harmony import */ var _angular_material_dialog__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/material/dialog */ "./node_modules/@angular/material/esm2015/dialog.js");
/* harmony import */ var src_app_shared_services_service_base__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/shared/services/service.base */ "./src/app/shared/services/service.base.ts");
/* harmony import */ var src_app_shared_services_billing_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/shared/services/billing.service */ "./src/app/shared/services/billing.service.ts");
/* harmony import */ var src_app_shared_services_admin_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/shared/services/admin.service */ "./src/app/shared/services/admin.service.ts");
/* harmony import */ var src_app_shared_helpers_controlError_helper__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/shared/helpers/controlError.helper */ "./src/app/shared/helpers/controlError.helper.ts");
/* harmony import */ var src_app_shared_services_aprovalMatrix_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/shared/services/aprovalMatrix.service */ "./src/app/shared/services/aprovalMatrix.service.ts");
/* harmony import */ var src_app_shared_enums_statesBilling_enum__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/shared/enums/statesBilling.enum */ "./src/app/shared/enums/statesBilling.enum.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _shared_pipes_arraySort_pipe__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./../../../shared/pipes/arraySort.pipe */ "./src/app/shared/pipes/arraySort.pipe.ts");
...
let PupupBillingComponent = class PupupBillingComponent {
    ...
    // tslint:disable-next-line: align
    serviceBase, billingService, adminService, 
    // tslint:disable-next-line: align
    ...
    validateMaxValue(costcenterId, valueBill) {
        let currentmatrix = [];
        ...
        if (currentmatrix.length > 0) {
            const sorts = new _shared_pipes_arraySort_pipe__WEBPACK_IMPORTED_MODULE_11__["ArraySortPipe"]();
            const matrixOrder = sorts.transform(currentmatrix, 'levelAprobation');
            const level = matrixOrder[currentmatrix.length - 1];
            if (!!level) {
...
PupupBillingComponent.ctorParameters = () => [
...
PupupBillingComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-pupup-billing',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./pupup-billing.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/modules/billing/pupup-billing/pupup-billing.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./pupup-billing.component.scss */ "./src/app/modules/billing/pupup-billing/pupup-billing.component.scss")).default]
    }),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StatusBillingEnum", function() { return StatusBillingEnum; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ControlErrorHelperService", function() { return ControlErrorHelperService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");


let ControlErrorHelperService = class ControlErrorHelperService {
    constructor() {
    }
    controlErros(res) {
        try {
...
ControlErrorHelperService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let BillingService = class BillingService {
    ...
    GetAllBilling() {
        return this.http.get(`${this.urls.urlbase}Billing/GetAllBilling`);
    }
    ...
    SaveBilling(billing, file) {
        ...
        return this.http.post(`${this.urls.urlbase}Billing/SaveBilling`, formData, { params });
    }
    GetAllStates() {
        return this.http.get(`${this.urls.urlbase}Billing/GetStates`);
    }
    GetAllTypesBilling() {
        return this.http.get(`${this.urls.urlbase}Billing/GetAllTypeBilling`);
    }
    GetDetailBilling(numberbilling) {
        return this.http.get(`${this.urls.urlbase}Billing/GetDetailBilling?numberBilling=` + numberbilling);
    }
    ContinueAprovalProcess(numberbilling, newStatus, observations) {
        const params = `numberbilling=${numberbilling}&userCode=${this.session.person.id}&newStatus=${newStatus}&observations=${observations}`;
        return this.http.get(`${this.urls.urlbase}Billing/ContinueAprovalProcess?${params}`);
    }
};
...
//# sourceMappingURL=modules-billing-billing-module-es2015.js.map